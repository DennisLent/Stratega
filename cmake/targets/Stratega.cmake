...
target_compile_options(Stratega PUBLIC -fPIC)

# get_target_property(boost_includes Boost::random INTERFACE_INCLUDE_DIRECTORIES)
# # target_include_directories(imgui INTERFACE ${boost_includes})
# target_include_directories(yaml-cpp INTERFACE ${boost_includes})

function(target_link_libraries_system target)
  set(libs ${ARGN})
  foreach(lib ${libs})
    message("Building HEADLESS mode ${ARGN}")
    get_target_property(lib_include_dirs ${lib} INTERFACE_INCLUDE_DIRECTORIES)
    message("dirs ${lib_include_dirs}")
    target_include_directories(${target} SYSTEM PRIVATE ${lib_include_dirs})
    target_link_libraries(${target} ${lib} project_options project_warnings)
  endforeach(lib)
endfunction(target_link_libraries_system)

target_link_libraries_system(Stratega Boost::random)
target_link_libraries(Stratega yaml-cpp)
target_link_libraries_system(Stratega RecastNavigation::Detour RecastNavigation::Recast RecastNavigation::DebugUtils RecastNavigation::DetourCrowd)
...
if(NOT SGA_BUILD_HEADLESS)
    target_link_libraries(Stratega IMGUII)
    ...
    if(SGA_BUILD_SFML_FROM_SOURCE OR CMAKE_SYSTEM_NAME MATCHES Linux)
        ...
        target_link_libraries_system(Stratega sfml)
    endif()
endif()
